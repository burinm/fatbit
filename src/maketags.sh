...
find ../atmel/src -iname "*.h" -or -iname "*.c" -or -iname "*.s" -or -name Makfile >> cscope.files
...
find ${SIMPLICITY_SDK}/hardware/kit/EFM32LG_STK3600 -iname "*.h" -or -iname "*.c" -or -iname "*.s" -or -name Makfile >> cscope.files
